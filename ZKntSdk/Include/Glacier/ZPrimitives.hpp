...
#pragma warning(disable : 4477)
        if (p_Format == GuidFormat::Dashes) {
            sscanf_s(
                p_Data.c_str(), "%08lX-%04hX-%04hX-%02hhX%02hhX-%02hhX%02hhX%02hhX%02hhX%02hhX%02hhX", &data1, &data2, &data3, &data4[0], &data4[1],
...
#pragma warning(default : 4477)
    ...
    ZString ToString(GuidFormat p_Format = GuidFormat::Dashes) const {
        ...
        if (p_Format == GuidFormat::Dashes) {
            s_Ret = sprintf_s(
                s_GUID, sizeof(s_GUID), "%08X-%04X-%04X-%02X%02X-%02X%02X%02X%02X%02X%02X", data1, data2, data3, data4[0], data4[1], data4[2],
                data4[3], data4[4], data4[5], data4[6], data4[7]
            );
        }
        else if (p_Format == GuidFormat::NoDashes) {
            s_Ret = sprintf_s(
                s_GUID, sizeof(s_GUID), "%08X%04X%04X%02X%02X%02X%02X%02X%02X%02X%02X", data1, data2, data3, data4[0], data4[1], data4[2], data4[3],
    ...
    uint32_t GetHashCode() const {
        return data1 ^ (data3 | (static_cast<uint32_t>(data2) << 16)) ^ (data4[7] | (static_cast<uint32_t>(data4[2]) << 24));
    }
...
class ZRepositoryID : public ZGuid {
  public:
...
template<> struct std::hash<ZRepositoryID> {
