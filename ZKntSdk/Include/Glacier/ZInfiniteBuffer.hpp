  ...
  public:
    ...
    void AdjustAllocation() {
        ...
        if (s_NewActualSize < m_nActualSize) {
            ZVirtualMemory::Release(m_pData, s_NewActualSize, m_nActualSize - s_NewActualSize, m_PageSize);
        }
        else if (s_NewActualSize > m_nActualSize) {
            ZVirtualMemory::Commit(m_pData, m_nActualSize, s_NewActualSize - m_nActualSize, m_PageSize);
        }
