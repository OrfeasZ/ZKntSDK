...
zknt::Hooks::Hooks() {
    ...
    PATTERN_HOOK(
        "\x48\x89\x5C\x24\x08\x48\x89\x6C\x24\x10\x48\x89\x74\x24\x18\x57\x41\x56\x41\x57\x48\x81\xEC\x00\x00\x00\x00\x48\x8B\xF9",
        "xxxxxxxxxxxxxxxxxxxxxxx????xxx", ZApplicationEngineWin32_MainWindowProc, LRESULT(ZApplicationEngineWin32*, HWND, UINT, WPARAM, LPARAM)
    );
    ...
    PATTERN_HOOK(
        "\x48\x8D\x05\x00\x00\x00\x00\x48\x89\x01\x48\x8B\x42\x10\x4C\x8B\x00\x4C\x89\x41\x08\x45\x33\xC0\x44\x89\x41\x10\x66\x44\x89\x41\x14\x48\x8B"
        "\x42\x20\x8B\x10\x48\x8D\x05\x00\x00\x00\x00\x48\x89\x01\x2B\xD1\x48\x8D\x05\x00\x00\x00\x00\x89\x51\x10\x48\x89\x41\x18\x48\xC7\x41\x20\x00"
        "\x00\x00\x00\x48\xC7\x41\x28\x00\x00\x00\x00\x48\xC7\x41\x30\x00\x00\x00\x00\x48\xC7\x41\x38\x00\x00\x00\x00\x48\xC7\x41\x40\x00\x00\x00\x00"
        "\x48\xC7\x41\x48\x00\x00\x00\x00\xC7\x41\x50\x00\x00\x00\x00\x44\x89\x41\x54\xC3",
        "xxx????xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx????xxxxxxxx????xxxxxxxxxxx????xxxx????xxxx????xxxx????xxxx????xxxx????xxx????xxxxx",
        ZKntLoadoutCollectionEntity_ZKntLoadoutCollectionEntity,
        ZKntLoadoutCollectionEntity * (ZKntLoadoutCollectionEntity * th, const ZComponentCreateInfo& Info)
    );
